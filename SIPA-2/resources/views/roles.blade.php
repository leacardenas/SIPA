...
<p id="ruta" class='navbar-text navbar-left'> $user->rol->sipa_roles_nombre </p>
            ...
            <div class="container">
                ...
                <ul class="responsive-table">
                    ...
                    <li class="table-row">
                        <div class="col col-1">
                            <p>{{$role->sipa_roles_id}}</p>
                        </div>
                        <div class="col col-2">
                            <p>{{$role->sipa_roles_codigo}}</p>
                        </div>
                        <div class="col col-3">
                            <p>{{$role->sipa_roles_nombre}}</p>
                        </div>
                        <div class="col col-4">
                            <p>{{$role->sipa_roles_descripcion}}</p>
                        </div>
                        <div class="col col-5">
                            <p>{{$role->sipa_roles_usuario_creador}}</p>
                        </div>
                        <div class="col col-6">
                            <p>{{$role->sipa_roles_usuario_actualizacion}}</p>
                        </div>
                        <div class="col col-7">
                            <p>{{$role->created_at}}</p>
                        </div>
