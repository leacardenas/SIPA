            ...
            <div id="cuadros">
                <div class="cuadro">
                    <button type="button" class="cuadrado" id="botonCuadrado"
                        ><img src="imagenes/booking.png"></button>
                    <p class=reservaActivo>Reservar activo</p>
                </div>
                <div class="cuadro">
                    <button type="button" class="cuadrado" id="botonCuadrado"
                        ><img src="imagenes/room.png"></button>
                    <p class="reservaSala">Reservar sala</p>
                </div>
                <div class="cuadro">
                    <button type="button" class="cuadrado" id="botonCuadrado"
                        ><img src="imagenes/reporte.png"></button>
                    <p class="reporteActivos">Ver reporte de mis activos</p>
                </div>
            </div>
        </div>
