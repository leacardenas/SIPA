...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2019 at 10:37 PM
...
--
-- Table structure for table `sipa_estado_activo`
--

CREATE TABLE `sipa_estado_activo` (
  `sipa_estado_activo_id` int(11) NOT NULL,
  `sipa_estado_activo_codigo` varchar(50) DEFAULT NULL,
...
--
-- Indexes for table `sipa_estado_activo`
--
...
--
-- AUTO_INCREMENT for table `sipa_estado_activo`
--
ALTER TABLE `sipa_estado_activo`
